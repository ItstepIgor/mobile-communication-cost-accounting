...
ALTER TABLE IF EXISTS owner
    ADD CONSTRAINT FK_owner_number FOREIGN KEY (number_id) REFERENCES number;

ALTER TABLE IF EXISTS owner
    ADD CONSTRAINT FK_owner_position FOREIGN KEY (position_id) REFERENCES position;

ALTER TABLE IF EXISTS number
    ADD CONSTRAINT FK_number_owner_group FOREIGN KEY (group_id) REFERENCES owner_group;
...
ALTER TABLE IF EXISTS number_rule_one_time_call_service
    ADD CONSTRAINT FK_number_rule_one_time_call_service_number FOREIGN KEY (number_id) REFERENCES number;
...
ALTER TABLE IF EXISTS result
    ADD CONSTRAINT FK_result_number FOREIGN KEY (number_id) REFERENCES number;

ALTER TABLE IF EXISTS individual_result
    ADD CONSTRAINT FK_individual_result_number FOREIGN KEY (number_id) REFERENCES number;