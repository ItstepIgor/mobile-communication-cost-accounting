...
public interface CallRepository extends JpaRepository<Call, Long> {
    ...
    @Query(value = "select * from calls where invoice_date=:date and short_number=:number", nativeQuery = true)
    List<Call> findCallByNumber(@Param("date") LocalDate date, @Param("number") String number);
}
